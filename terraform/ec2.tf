...
resource "aws_security_group" "ec2" {
  ...
  ingress {
    ...
    to_port     = 22
    protocol    = "tcp"
    cidr_blocks = ["0.0.0.0/0"] # In production, restrict this to your IP or VPN range
  }
...
resource "aws_iam_policy" "ec2_rds_access" {
  name        = "${var.project_name}-ec2-rds-access"
  description = "Policy for EC2 instances to access RDS"
...
resource "aws_iam_role_policy_attachment" "ec2_rds_access_attachment" {
...
resource "aws_launch_template" "app" {
  ...
  user_data = base64encode(<<-EOF
    ...
    echo "<h1>CreditoSolicitud Application</h1>" > /var/www/html/index.html
    echo "Setup complete"
  EOF
  )
